...
$releaseUrl = "https://github.com/SpikeHD/fwd/releases/latest/download/fwd-$target.exe"
$tempPath = [System.IO.Path]::GetTempFileName() + ".exe"
$installPath = "C:\Program Files\fwd"

# Download fwd binary
Write-Host "Downloading fwd for $arch system..."
...
Move-Item -Path $tempPath -Destination "$installPath\fwd.exe" -Force
...
Write-Host "fwd installed successfully at $installPath"
